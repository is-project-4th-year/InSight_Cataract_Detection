            ...
            with col2:
                with st.spinner("Analyzing image... (Connecting to backend)"):
                    try:
                        ...
                        # Get the raw probability from the backend
                        # (This should be the probability of Class 1: Cataract)
                        pred_prob = result["prediction_probability"]
                        
                        # Decode Grad-CAM
                        gc_bytes = base64.b64decode(result["gradcam_image_base64"])

                        # --- CORRECT LOGIC FOR BINARY CLASSIFICATION ---
                        # Assuming your model was trained as: 0 = No Cataract, 1 = Cataract
                        # If the probability of Class 1 is > 0.5, it's Cataract.
                        ...
                        if pred_prob > 0.5:
                            ...
                            # If prob of Class 1 is 0.1, then prob of Class 0 (No Cataract) is 0.9
